...
var url = "http://127.0.0.1:4000/api/products";
it("should delete a product by ID", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                productID = 11;
                return [4 /*yield*/, axios.delete("".concat(url, "/").concat(productID))];
            case 1:
                res = _a.sent();
...
test("Get an Product by ID", function () { return __awaiter(void 0, void 0, void 0, function () {
    var orderId, res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                orderId = 15;
                return [4 /*yield*/, axios.get("".concat(url, "/").concat(orderId))];
            case 1:
                res = _a.sent();
...
it("should create a new product", function () { return __awaiter(void 0, void 0, void 0, function () {
    var newProduct, res, createdProduct, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                newProduct = {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, axios.post(url, newProduct)];
            case 2:
                res = _a.sent();
            ...
            case 3:
                error_1 = _a.sent();
                console.error("Error creating a new product:", error_1);
                return [3 /*break*/, 4];
