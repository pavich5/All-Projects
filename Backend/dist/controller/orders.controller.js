...
var OrdersController = /** @class */ (function () {
    ...
    OrdersController.getAllOrders = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userEmail, allOrders, error_1;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, orders_model_1.OrdersModel.getOrderById(Number(id))];
                    case 1:
                        foundOrder = _a.sent();
                        res.json(foundOrder);
                        return [3 /*break*/, 3];
    ...
    OrdersController.createOrder = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var newOrder, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, orders_model_1.OrdersModel.createOrder(req.body)];
                    case 1:
                        newOrder = _a.sent();
                        res.json(newOrder);
                        return [3 /*break*/, 3];
